...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    IsolateManagerMessagePortController$(port, initialParams, onDispose, $R, $P) {
      var t1 = new A.IsolateManagerMessagePortController(port, onDispose, new A._AsyncBroadcastStreamController(null, null, type$._AsyncBroadcastStreamController_dynamic), new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_void), type$._AsyncCompleter_void), $R._eval$1("@<0>")._bind$1($P)._eval$1("IsolateManagerMessagePortController<1,2>"));
    ...
    IsolateManagerMessagePortController: function IsolateManagerMessagePortController(t0, t1, t2, t3, t4) {
      var _ = this;
      _.port = t0;
      _.onDispose = t1;
  ...
  A.IsolateManagerMessagePortController_closure.prototype = {
    call$1($event) {
      ...
      try {
        ...
        t1 = this.$this._streamController;
        t2 = A._instanceType(t1)._precomputed1._as(result);
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t1._closed.future.then$1$1(new A.main__closure0(), type$.void);
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(@)", "Null(JSObject)", "~(~())", "~(Object?)", "@(@)", "Null(@)", "Null()", "~(Object,StackTrace)", "Null(Object,StackTrace)", "Object?(Object?)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "~(Object?,Object?)", "Null(Object?)", "ImType<Object>(@)", "MapEntry<ImType<Object>,ImType<Object>>(@,@)", "Future<~>(IsolateBridgeSharedWorkerController<Object?,Object?>,Object?)", "Null(~)"],
